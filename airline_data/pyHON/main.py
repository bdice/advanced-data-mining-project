...
InputFileName = '/hadoop-fuse/var/eecs598w19/users/group_3/workspace/6ae284602fc56465315a18f804b30bcb/hon_itineraries.txt/part-*'
...
#OutputRulesFile = '../data/rules-first-order-airports.csv'
#OutputNetworkFile = '../data/network-first-order-airports.csv'
